...
public class CannonView extends SurfaceView
    ...
    public void newGame() {
        ...
        timeLeft = 50; // start the countdown at 10 seconds( limit time left in game )
    ...
    private void showGameOverDialog(final int messageId) {
        ...
        dialogBuilder.setTitle(getResources().getString(messageId)); dialogBuilder.setCancelable(false);
// display number of shots fired and total time elapsed
        dialogBuilder.setMessage(getResources().getString( R.string.results_format, shotsFired, totalElapsedTime)); dialogBuilder.setPositiveButton(R.string.reset_game,
