package vn.edu.fpt.tipcalculator4;
// MainActivity.java
...
public class MainActivity extends Activity
{
    ...
    private Button testButtonInJavaCode;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        testButtonInJavaCode = (Button) findViewById(R.id.testButton);
        testButtonInJavaCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(),"Ban vua Click TestButton",Toast.LENGTH_LONG).show();
            }
        });
    } // end method onCreate
